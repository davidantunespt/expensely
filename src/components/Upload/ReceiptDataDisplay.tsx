...
export function ReceiptDataDisplay({
  ...
  return (
    <div className="relative">
      ...
      <div
        className={`fixed top-0 left-0 h-full w-[50vw] bg-white shadow-xl transform transition-transform duration-300 ease-in-out z-50 ${
            ...
            <Box style={{ backgroundColor: "white" }}>
              <div className="flex items-center justify-between">
                <div className="flex flex-col flex-1 min-w-0">
                  ...
                  <div className="text-xs text-gray-500 font-normal mt-0.5 truncate">
                    {file.data.vendor} &bull; $
                    {file.data.totalAmount?.toFixed(2)} &bull;{" "}
                    {formatDateTime(file.data.date, "dd/MM/yyyy")}
                  </div>
                </div>
                <div className="flex items-center space-x-2">
                  {file.preview && (
                    <button
                      onClick={() => {
                        ...
                        setViewingFileId(
                          viewingFileId === file.fileId ? null : file.fileId
                        );
                      }}
                  ...
                  <button
                    onClick={() => {
                      ...
                      setEditingFileId(
                        editingFileId === file.fileId ? null : file.fileId
                      );
                    }}
                    className="p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded transition-colors cursor-pointer"
                    title={
              ...
              >
                <div className="space-y-4">
                  {/* Extraction Status */}
                  <div
                    className={`flex items-center mb-6 p-3 ${
                      file.isReviewed
                      ...
                      <>
                        ...
                        <div>
                          <p className="text-base font-medium text-blue-900">
                            Document Reviewed and Ready
                          </p>
                          <p className="text-xs text-blue-700">
                            This receipt has been verified and is ready to be
                            saved
                          </p>
                        </div>
                      </>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <DateTimeInput
                      ...
                      onChange={(value) =>
                        handleDataUpdate(file.fileId, "date", value)
                      }
                      disabled={editingFileId !== file.fileId}
                    />
                    ...
                    <div className="space-y-2">
                      <SelectWithLabel
                        ...
                        onValueChange={(value) =>
                          handleDataUpdate(file.fileId, "category", value)
                        }
                        disabled={editingFileId !== file.fileId}
                      >
                    ...
                    <div className="space-y-2">
                      <SelectWithLabel
                        ...
                        onValueChange={(value) =>
                          handleDataUpdate(file.fileId, "paymentMethod", value)
                        }
                        disabled={editingFileId !== file.fileId}
                      >
                        <SelectTrigger className="w-full px-2 py-2 border-2 border-gray-200 rounded-lg text-gray-900 text-sm leading-none bg-white">
                    ...
                    <div className="md:col-span-2 space-y-3">
                      <CheckboxWithLabel
                        ...
                        onCheckedChange={(checked) =>
                          handleDataUpdate(file.fileId, "isDeductible", checked)
                        }
                        label="This expense is tax deductible"
                        disabled={editingFileId !== file.fileId}
                      >
                        <p className="text-sm text-gray-600">
                          Check this box if this expense can be claimed as a
                          business deduction.
                        </p>
                      </CheckboxWithLabel>
                    </div>
                      ...
                      <div className="w-full bg-gray-50 border-2 border-gray-100 rounded-lg overflow-hidden">
                        <table className="w-full">
                          <thead className="bg-gray-100">
                            <tr>
                              <th className="px-4 py-2 text-left text-xs font-semibold text-gray-600 w-1/2">
                                Item
                              </th>
                              ...
                              <th className="px-2 py-2 text-right text-xs font-semibold text-gray-600 w-40">
                                Total
                              </th>
                              {editingFileId === file.fileId && (
                              ...
                              >
                                {editingFileId === file.fileId ? (
                                  <>
                                    ...
                                    <td className="px-4 py-2 text-sm text-gray-900 leading-tight text-right">
                                      <div className="relative">
                                        <span className="absolute left-2 top-1/2 transform -translate-y-1/2 text-gray-600 text-sm">
                                          $
                                        </span>
                                        <input
                                          type="number"
                                    ...
                                    <td className="px-2 py-2 text-center align-middle">
                                      <button
                                        ...
                                        onClick={() =>
                                          handleRemoveItem(file.fileId, index)
                                        }
                                        title="Remove item"
                                      >
                                        ×
                          ...
                          <tfoot className="bg-gray-50 border-t border-gray-200">
                            ...
                            {file.data.totalDiscount > 0 && (
                              <tr>
                                ...
                                <td className="px-4 py-2 text-sm font-semibold text-gray-900 text-right">
                                  -${file.data.totalDiscount.toFixed(2)}
                                </td>
                              </tr>
                            )}
                  ...
                  {!file.isDiscarding && (
                    <div className="mt-6 pt-4 border-t border-gray-300 flex justify-end space-x-3 cursor-pointer">
                      ...
                      {!file.isReviewed ? (
                        ...
                        <button
                          onClick={() =>
                            onFileUpdated(file.fileId, { isReviewed: false })
                          }
